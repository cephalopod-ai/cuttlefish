...
<!-- GILES:GEMINI-DOCS-GOVERNANCE:START -->
Gemini must follow AGENTS.md first.
Do not make runtime code edits unless explicitly requested.
Documentation claims must be source-grounded; no invented docs or claims.
