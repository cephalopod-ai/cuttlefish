 ...
 *
 * Shared between the gateway (source of truth) and the web dashboard so the two
 * never drift out of sync again — see ARC-002: the web package used to hand-mirror
 * this type, and the mirror already drifted once (RDC-006, closed 2026-06-30).
 */
