// Settings section compatibility facade: smaller sections remain local; inbox
// editing lives in settings-email-section; engine/model/effort editing lives in
// settings-engine-configuration.
// Re-exports preserve the original imports and component identity; keep them.
import type { SharedConfigProps } from "./settings-config-section-types"
export { EmailSettingsSection } from "./settings-email-section"
export { EngineConfigurationSection } from "./settings-engine-configuration"
...
export function GatewayWorkspacesSection({
  ...
  return (
    <Section title="Gateway & Workspaces">
      ...
      <FieldHint>
        These watchdog settings control when a quiet turn is treated as stalled and whether Cuttlefish retries once before escalating.
      </FieldHint>
    </Section>
  )
}
    ...
    <Section title="Orchestration">
      ...
      <FieldRow label="Config Dir">
        <SettingsInput
          ...
          placeholder="~/.cuttlefish/orchestration"
        />
      </FieldRow>
      <FieldRow label="DB Path">
        <SettingsInput
          ...
          placeholder="~/.cuttlefish/orchestration/orchestration.db"
        />
      </FieldRow>
      <FieldRow label="Worktree Root">
        <SettingsInput
          ...
          placeholder="~/.cuttlefish/orchestration/worktrees"
        />
      </FieldRow>
