...
export interface CuttlefishSettings {
...
export const DEFAULTS: CuttlefishSettings = {
  accentColor: null,
  portalName: null,
  portalSubtitle: null,
  portalEmoji: null,
...
export function loadSettings(): CuttlefishSettings {
...
export function saveSettings(settings: CuttlefishSettings): void {
