/**
 * Cuttlefish Talk — the voice orchestrator persona (Path 1).
 *
 ...
 * orchestrator reads on demand: `~/.cuttlefish/talk/card-reference.md` (referenced as
 * `talk/card-reference.md`, relative to the talk session's working directory).
 *
 * HOT-RELOAD: the live persona is read from `~/.cuttlefish/talk/orchestrator-persona.md`
...
export const PERSONA_FILE = join(CUTTLEFISH_HOME, "talk", "orchestrator-persona.md");
