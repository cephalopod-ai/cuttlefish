...
async function main() {
  ...
  try {
    ...
    await page.screenshot({ path: '/tmp/approval-dashboard-fixed.png' });
    console.log('✓ Screenshot saved: /tmp/approval-dashboard-fixed.png');

    console.log('\nPage loaded successfully. Browser will stay open so you can inspect.');
