...
| [`14-authorization-and-approvals.md`](14-authorization-and-approvals.md) | operator/bounded delegated decisions, checkpoint vocabulary, pairing auth modes, scoped tokens; additional `CUT-EA-*` automated acceptance fixtures | Who can approve, pair, and act — and what must fail closed? |
