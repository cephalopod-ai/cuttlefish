...
The control-plane items above (`RSP-CUT-001`, `SEC-CUT-016`, `RSP-CUT-002`,
`REL-CUT-001`, `DEP-CUT-002`) remain the blocking backlog. `PERF-CUT-001`
through `PERF-CUT-003` were completed on 2026-08-17 and are retained with
their evidence in [TODO_HISTORY.md](TODO_HISTORY.md).
