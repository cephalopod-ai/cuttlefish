...
| `docs/test_scenarios/20-session-authority-collision-and-arbitration.md` | authority collision/arbitration scenario cards | current | playtest / QA stewardship | added 2026-07-20 (SA-01–SA-25) | Same-target authority conflicts, COO/Parliamentarian arbitration target, priority/deconfliction, fallback, crash recovery, and board-independent agent-to-human indicators. |
